...
local function createFilesystem(address, proxy, relativeDirectory)
    return box.createComponent{
        ...
        callback = {
            ...
            open = function(path, mode) checkArg(1, path, "string") return proxy.open(relativeDirectory .. path, mode) end,
            seek = proxy.seek,
            makeDirectory = function(path) checkArg(1, path, "string") return proxy.makeDirectory(relativeDirectory .. path) end,
            ...
            list = function(path) checkArg(1, path, "string") return proxy.list(relativeDirectory .. path) end,
